...
if (jQuery("#realtime").length) {
    ...
    var plot = jQuery.plot("#realtime", [getRandomData()], {
        series: {
    ...
    jQuery("#footer").prepend("Flot " + jQuery.plot.version + " – ");
}
    /* ======================================================================
    Setting various options
    ====================================================================== */
	if (jQuery("#setting-various-options").length) {
    var d1 = [];
    for (var i = 0; i < Math.PI * 3; i += 0.35) {
    ...
    jQuery.plot("#setting-various-options", [{
        label: "sin(x)",
        data: d1
    }, {
        label: "cos(x)",
